...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="index.jsp">Club Game</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Profiles</h1>
			<!-- Icon Divider-->
			...
			User Name : <%=session.getAttribute("name")%>
			<br>
			Gmail : <%=session.getAttribute("name")%>@gmail.com
